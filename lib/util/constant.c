...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_arr8_id(const aclspv_wrd_t c_arrcount, h_util_ctx_t h_ctx)
{
	util_constant* ae2f_restrict const C = aclutil_mk_constant_node(c_arrcount, h_ctx);
	ae2f_expected_but_else(C) return 0;
	ae2f_expected_but_else(C->m_key_0 == c_arrcount && !C->m_key_1) return 0;
	ae2f_expected_but_else(C->m_const_val_id)
		C->m_const_val_id = aclutil_mk_constant_val_id(c_arrcount, h_ctx);

	if(C->m_arr8_id) return C->m_arr8_id;
	ae2f_expected_but_else(aclid_mk_default_id(ID_DEFAULT_I8, h_ctx))
		return 0;
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_arr16_id(const aclspv_wrd_t c_arrcount, h_util_ctx_t h_ctx)
{
	util_constant* ae2f_restrict const C = aclutil_mk_constant_node(c_arrcount, h_ctx);
	ae2f_expected_but_else(C) return 0;
	ae2f_expected_but_else(C->m_key_0 == c_arrcount && !C->m_key_1) return 0;
	...
	ae2f_expected_but_else(aclid_mk_default_id(ID_DEFAULT_I16, h_ctx))
		return 0;
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_arr32_id(const aclspv_wrd_t c_arrcount, h_util_ctx_t h_ctx)
{
	util_constant* ae2f_restrict const C = aclutil_mk_constant_node(c_arrcount, h_ctx);
	ae2f_expected_but_else(C) return 0;
	ae2f_expected_but_else(C->m_key_0 == c_arrcount && !C->m_key_1) return 0;
...
ae2f_inline static aclspv_id_t	util_mk_constant_arrspec32_id(const aclspv_wrd_t c_key, const aclspv_wrd_t c_arrcount, h_util_ctx_t h_ctx)
{
	...
	ae2f_expected_but_else(C->m_const_spec_id)
		aclutil_mk_constant_spec_id(c_key, c_arrcount, h_ctx);
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_arr128_id(const aclspv_wrd_t c_arrcount, h_util_ctx_t h_ctx)
{
	util_constant* ae2f_restrict const C	= aclutil_mk_constant_node(c_arrcount, h_ctx);
	...
	ae2f_expected_but_else(C)			return 0;
	ae2f_expected_but_else(C->m_key_0 == c_arrcount && !C->m_key_1)	return 0;
	ae2f_expected_but_else(aclutil_mk_constant_val_id(c_arrcount, h_ctx)) return 0;
	assert(ID_U32V4);
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_struct_id(const aclspv_wrd_t c_wrdcount, h_util_ctx_t h_ctx) {
	util_constant* ae2f_restrict const C = aclutil_mk_constant_node(c_wrdcount, h_ctx);
	ae2f_expected_but_else(C) return 0;
	ae2f_expected_but_else(C->m_key_0 == c_wrdcount && !C->m_key_1) return 0;
	ae2f_expected_but_else(C->m_arr32_id && c_wrdcount > 1)
		C->m_arr32_id = aclutil_mk_constant_arr32_id(c_wrdcount, h_ctx);
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_struct128_id(const aclspv_wrd_t c_veccount, h_util_ctx_t h_ctx) {
#if 1
	util_constant* ae2f_restrict const C = aclutil_mk_constant_node(c_veccount, h_ctx);

	ae2f_expected_but_else(C) {
		assert(0 && "C is null");
		return 0;
	}
	ae2f_expected_but_else(C->m_arr128_id = aclutil_mk_constant_arr128_id(c_veccount, h_ctx)) {
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_structprivspec_id(const aclspv_wrd_t c_key, const aclspv_wrd_t c_wrdcount, h_util_ctx_t h_ctx) {
	util_constant* ae2f_restrict const C = aclutil_mk_constant_node(c_key, h_ctx);
	ae2f_expected_but_else(C) return 0;
	ae2f_expected_but_else(C->m_key_0 == c_key && !C->m_key_1) return 0;
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_structpriv_id(const aclspv_wrd_t c_wrdcount, h_util_ctx_t h_ctx) {
	...
	ae2f_expected_but_else(C->m_arr32_id)
		ae2f_expected_but_else(C->m_arr32_id = aclutil_mk_constant_arr32_id(c_wrdcount, h_ctx))
		return 0;
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_ptr_id(const aclspv_wrd_t c_wrdcount, h_util_ctx_t h_ctx) {
	...
	_util_mk_constant_ptr_tmpl(
			...
			, ID, c_wrdcount
			, h_ctx
			, aclutil_mk_constant_structpriv_id
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_ptr_uniform_id(const aclspv_wrd_t c_wrdcount, h_util_ctx_t h_ctx) {
	...
	ae2f_expected_but_else(C->m_struct128_id)
		C->m_struct128_id = aclutil_mk_constant_struct128_id(sz_to_count(c_wrdcount), h_ctx);
...
ACLSPV_ABI_IMPL aclspv_id_t	aclutil_mk_constant_ptr_workspec_id(const aclspv_wrd_t c_key, const aclspv_wrd_t c_wrdcount, h_util_ctx_t h_ctx) {
	util_constant* ae2f_restrict C = aclutil_mk_constant_node(c_key, h_ctx);
	ae2f_expected_but_else(C) return 0;
	ae2f_expected_but_else(C->m_structprivspec_id)
		(void)aclutil_mk_constant_structprivspec_id(c_key, c_wrdcount, h_ctx);
