...
"__kernel void KERNEL_0(uint pushu32, __global uint* __attribute__((annotate(\"aclspv_set(2)\"))) globu32, __global float* globf32, __local uint* locu32, float pushf32, struct STRUCTURE push_struct) { globu32[get_global_id(0)] += pushu32 + sin(globf32[get_global_id(0)]); }"
